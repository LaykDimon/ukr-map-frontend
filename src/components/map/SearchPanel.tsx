...
const SearchPanel: React.FC<SearchPanelProps> = React.memo(({
  ...
  }, [clearSearch, localSearch, displayResults, activeIndex, onPersonHover, handleClick]);
          ...
          {!searchLoading && displayResults.map((result, index) => {
            ...
            return (
              <li
                ...
                style={{
                  ...(isActive ? { backgroundColor: '#2a2a2a' } : undefined),
                  ...(!hasCoords ? { opacity: 0.5, cursor: 'default' } : undefined),
                }}
              >
                <span>
                  {result.person.name}
                ...
                {result.similarity != null && (
                  <span style={{ fontSize: 11, color: '#666', marginLeft: 8, flexShrink: 0 }}>
